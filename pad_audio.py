...
def pad_audio(audio_path, output_path='datasets/Processed_v2/', target_length=3000, target_sr=44100):
    """
...
if __name__ == '__main__':
    run_func_on_all_datasets('datasets/Storage/Ver1', pad_audio, None)
